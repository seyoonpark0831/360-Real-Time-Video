...
# Get Right Image After Stitching
def get_stitched_right_image(img1, img2, M):
	...
	# Warp images to get the resulting image
	result_img = cv2.warpPerspective(img2, transform_array.dot(M),(x_max-x_min, y_max-y_min))*0
	result_img[transform_dist[1]:w1+transform_dist[1],transform_dist[0]:h1+transform_dist[0]] = img1
...
def get_stitched_image_points(img1, img2, M):
